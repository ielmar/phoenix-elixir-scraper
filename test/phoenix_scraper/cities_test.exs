defmodule PhoenixScraper.CitiesTest do
  use PhoenixScraper.DataCase

  alias PhoenixScraper.Cities

  describe "cities" do
    alias PhoenixScraper.Cities.City

    import PhoenixScraper.CitiesFixtures
